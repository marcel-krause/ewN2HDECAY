...
#include "looptools.h"
 ...
 amplitudes(121) = (0.015625D0*CA22*EL2*MC2*SA12*B0(x, MC2, MH12))/(MW2*PI2*SB2*SW2)

 amplitudes(122) = (0.015625D0*EL2*MC2*B0(x, MC2, MH22)*DBLE((CA1*CA3 - 1.D0*SA1*SA2*SA3)**INT(2.D0)))/(MW2*PI2*SB2*SW2)

 amplitudes(123) = (0.015625D0*EL2*MC2*B0(x, MC2, MH32)*DBLE((CA3*SA1*SA2 + CA1*SA3)**INT(2.D0)))/(MW2*PI2*SB2*SW2)

 amplitudes(124) = (-0.015625D0*EL2*MC2*B0(x, MC2, MZ2))/(MW2*PI2*SW2)

 amplitudes(125) = (-0.015625D0*CB2*EL2*MC2*B0(x, MA02, MC2))/(MW2*PI2*SB2*SW2)

 amplitudes(126) = (-0.03125D0*CKM21*CKMC21*EL2*MD2*YukS3Quark1*B0(x, MD2, MW2))/(MW2*PI2*SW2)

 amplitudes(127) = (-0.03125D0*CKM22*CKMC22*EL2*MS2*YukS3Quark1*B0(x, MS2, MW2))/(MW2*PI2*SW2)

 amplitudes(128) = (-0.03125D0*CKM23*CKMC23*EL2*MB2*YukS3Quark1*B0(x, MB2, MW2))/(MW2*PI2*SW2)

 amplitudes(129) = (-0.03125D0*CB*CKM21*CKMC21*EL2*MD2*YukS3Quark2*B0(x, MD2, MHp2))/(MW2*PI2*SB*SW2)

 amplitudes(130) = (-0.03125D0*CB*CKM22*CKMC22*EL2*MS2*YukS3Quark2*B0(x, MHp2, MS2))/(MW2*PI2*SB*SW2)

 amplitudes(131) = (-0.03125D0*CB*CKM23*CKMC23*EL2*MB2*YukS3Quark2*B0(x, MB2, MHp2))/(MW2*PI2*SB*SW2)

 amplitudes(132) = (-0.05555555555555555D0*EL2*(-1.D0 + 2.D0*B0(x, 0.D0, MC2)))/PI2

 amplitudes(133) = (0.013888888888888888D0*EL2*(3.D0*CW2 - 1.D0*SW2)*(-1.D0 + 2.D0*B0(x, MC2, MZ2)))/(CW2*PI2)
