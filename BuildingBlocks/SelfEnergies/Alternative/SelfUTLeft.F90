...
#include "looptools.h"
 ...
 amplitudes(1) = (0.03125D0*CKM31*CKMC11*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2) + (0.5D0*EL2*MD2*SB&
 ...
 amplitudes(2) = (0.03125D0*CKM32*CKMC12*((-0.5D0*EL2*MS2*SB2*A0(MS2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2) + (0.5D0*EL2*MS2*SB&
 ...
 amplitudes(3) = (0.03125D0*CKM33*CKMC13*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2) + (0.5D0*EL2*MB2*SB&
 ...
 amplitudes(4) = (0.03125D0*CKM31*CKMC11*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2) + (0.5D0*EL2*MD2*SB&
 ...
 amplitudes(5) = (0.03125D0*CKM32*CKMC12*((0.5D0*EL2*MS2*SB2*A0(MHp2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2) - (0.5D0*EL2*MS2*SB&
 ...
 amplitudes(6) = (0.03125D0*CKM33*CKMC13*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2) + (0.5D0*EL2*MB2*SB&
