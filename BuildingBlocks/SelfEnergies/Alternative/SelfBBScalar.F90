...
#include "looptools.h"
 ...
 amplitudes(121) = (0.015625D0*EL2*MB2*B0(x, MB2, MH12)*DBLE(YukS1Quark1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(122) = (0.015625D0*EL2*MB2*B0(x, MB2, MH22)*DBLE(YukS1Quark2**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(123) = (0.015625D0*EL2*MB2*B0(x, MB2, MH32)*DBLE(YukS1Quark3**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(124) = (-0.015625D0*EL2*MB2*B0(x, MB2, MZ2)*DBLE(YukS2Quark1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(125) = (-0.015625D0*EL2*MB2*B0(x, MA02, MB2)*DBLE(YukS2Quark2**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(126) = (-0.03125D0*CKM13*CKMC13*EL2*MU2*YukS3Quark1*B0(x, MU2, MW2))/(MW2*PI2*SW2)

 amplitudes(127) = (-0.03125D0*CKM23*CKMC23*EL2*MC2*YukS3Quark1*B0(x, MC2, MW2))/(MW2*PI2*SW2)

 amplitudes(128) = (-0.03125D0*CKM33*CKMC33*EL2*MT2*YukS3Quark1*B0(x, MT2, MW2))/(MW2*PI2*SW2)

 amplitudes(129) = (-0.03125D0*CB*CKM13*CKMC13*EL2*MU2*YukS3Quark2*B0(x, MHp2, MU2))/(MW2*PI2*SB*SW2)

 amplitudes(130) = (-0.03125D0*CB*CKM23*CKMC23*EL2*MC2*YukS3Quark2*B0(x, MC2, MHp2))/(MW2*PI2*SB*SW2)

 amplitudes(131) = (-0.03125D0*CB*CKM33*CKMC33*EL2*MT2*YukS3Quark2*B0(x, MHp2, MT2))/(MW2*PI2*SB*SW2)

 amplitudes(132) = (-0.013888888888888888D0*EL2*(-1.D0 + 2.D0*B0(x, 0.D0, MB2)))/PI2

 amplitudes(133) = (0.006944444444444444D0*EL2*(3.D0*CW2 + SW2)*(-1.D0 + 2.D0*B0(x, MB2, MZ2)))/(CW2*PI2)
