...
#include "looptools.h"
 ...
 amplitudes(129) = (0.015625D0*EL2*(2.D0*CW2*SW2*x + 2.D0*CW2*SW2*A0(ML2) - 2.D0*CW2*SW2*A0(MZ2) - 2.D0*CW2*ML2*SW2*B0(x, ML2, MZ&
  &2) + 2.D0*CW2*MZ2*SW2*B0(x, ML2, MZ2) - 2.D0*CW2*SW2*x*B0(x, ML2, MZ2) - 1.D0*x*DBLE(CW**INT(4.D0)) - 1.D0*A0(ML2)*DBLE(CW**IN&
  &T(4.D0)) + A0(MZ2)*DBLE(CW**INT(4.D0)) + ML2*B0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*MZ2*B0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)&
  &) + x*B0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*x*DBLE(SW**INT(4.D0)) - 1.D0*A0(ML2)*DBLE(SW**INT(4.D0)) + A0(MZ2)*DBLE(SW**I&
  &NT(4.D0)) + ML2*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) - 1.D0*MZ2*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) + x*B0(x, ML2, MZ2)*DBLE(SW&
 ...
 amplitudes(132) = (0.03125D0*EL2*(-1.D0*x + A0(MW2) - 1.D0*MW2*B0(x, 0.D0, MW2) + x*B0(x, 0.D0, MW2)))/(PI2*SW2*x)
