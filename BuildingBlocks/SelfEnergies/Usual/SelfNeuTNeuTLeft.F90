...
#include "looptools.h"
 ...
 amplitudes(1) = (-0.03125D0*EL2*ML2*B1(x, ML2, MW2)*DBLE(YukS3Lep1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(2) = (-0.03125D0*EL2*ML2*B1(x, ML2, MHp2)*DBLE(YukS3Lep2**INT(2.D0)))/(MW2*PI2*SW2)
 ...
 amplitudes(6) = (-0.03125D0*EL2*(1.D0 + 2.D0*B1(x, ML2, MW2)))/(PI2*SW2)
