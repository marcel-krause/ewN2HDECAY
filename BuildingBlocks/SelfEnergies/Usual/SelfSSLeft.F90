...
#include "looptools.h"
 ...
 amplitudes(6) = (0.03125D0*CKM12*CKMC12*((-0.5D0*EL2*MU2*SB2*A0(MU2))/(MW2*SW2) + (0.5D0*EL2*MU2*SB2*A0(MW2))/(MW2*SW2) - (0.5D0&
 ...
 amplitudes(7) = (0.03125D0*CKM22*CKMC22*((-0.5D0*EL2*MC2*SB2*A0(MC2))/(MW2*SW2) + (0.5D0*EL2*MC2*SB2*A0(MW2))/(MW2*SW2) - (0.5D0&
  &*EL2*MC2*SB2*B0(x, MC2, MW2))/SW2 + (0.5D0*EL2*MC2*SB2*x*B0(x, MC2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*B0(x, MC2, MW2)*DBLE(MC**&
  &INT(4.D0)))/(MW2*SW2)))/(PI2*SB2*x)

 amplitudes(8) = (0.03125D0*CKM32*CKMC32*((-0.5D0*EL2*MT2*SB2*A0(MT2))/(MW2*SW2) + (0.5D0*EL2*MT2*SB2*A0(MW2))/(MW2*SW2) - (0.5D0&
  &*EL2*MT2*SB2*B0(x, MT2, MW2))/SW2 + (0.5D0*EL2*MT2*SB2*x*B0(x, MT2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*B0(x, MT2, MW2)*DBLE(MT**&
  &INT(4.D0)))/(MW2*SW2)))/(PI2*SB2*x)

 amplitudes(9) = (0.03125D0*CKM12*CKMC12*((0.5D0*CB2*EL2*MU2*A0(MHp2))/(MW2*SW2) - (0.5D0*CB2*EL2*MU2*A0(MU2))/(MW2*SW2) - (0.5D0&
 ...
 amplitudes(10) = (0.03125D0*CKM22*CKMC22*((-0.5D0*CB2*EL2*MC2*A0(MC2))/(MW2*SW2) + (0.5D0*CB2*EL2*MC2*A0(MHp2))/(MW2*SW2) - (0.5&
 ...
 amplitudes(11) = (0.03125D0*CKM32*CKMC32*((0.5D0*CB2*EL2*MT2*A0(MHp2))/(MW2*SW2) - (0.5D0*CB2*EL2*MT2*A0(MT2))/(MW2*SW2) - (0.5D&
 ...
 amplitudes(13) = (0.001736111111111111D0*EL2*(-6.D0*CW2*SW2*x - 6.D0*CW2*SW2*A0(MS2) + 6.D0*CW2*SW2*A0(MZ2) + 6.D0*CW2*MS2*SW2*B&
  &0(x, MS2, MZ2) - 6.D0*CW2*MZ2*SW2*B0(x, MS2, MZ2) + 6.D0*CW2*SW2*x*B0(x, MS2, MZ2) - 9.D0*x*DBLE(CW**INT(4.D0)) - 9.D0*A0(MS2)&
  &*DBLE(CW**INT(4.D0)) + 9.D0*A0(MZ2)*DBLE(CW**INT(4.D0)) + 9.D0*MS2*B0(x, MS2, MZ2)*DBLE(CW**INT(4.D0)) - 9.D0*MZ2*B0(x, MS2, M&
  &Z2)*DBLE(CW**INT(4.D0)) + 9.D0*x*B0(x, MS2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*x*DBLE(SW**INT(4.D0)) - 1.D0*A0(MS2)*DBLE(SW**INT(&
 ...
 amplitudes(14) = (0.03125D0*CKM12*CKMC12*EL2*(-1.D0*x - 1.D0*A0(MU2) + A0(MW2) + MU2*B0(x, MU2, MW2) - 1.D0*MW2*B0(x, MU2, MW2) &
  &+ x*B0(x, MU2, MW2)))/(PI2*SW2*x)

 amplitudes(15) = (0.03125D0*CKM22*CKMC22*EL2*(-1.D0*x - 1.D0*A0(MC2) + A0(MW2) + MC2*B0(x, MC2, MW2) - 1.D0*MW2*B0(x, MC2, MW2) &
  &+ x*B0(x, MC2, MW2)))/(PI2*SW2*x)

 amplitudes(16) = (0.03125D0*CKM32*CKMC32*EL2*(-1.D0*x - 1.D0*A0(MT2) + A0(MW2) + MT2*B0(x, MT2, MW2) - 1.D0*MW2*B0(x, MT2, MW2) &
