double precision function H2toDDBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 double precision :: dRR11, dRR12, dRR13, dRR21, dRR22, dRR23, dRR31, dRR32, dRR33, dYukS1Quark2
 ...
 select case (x)
	case (1)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1KanUsual() - &
						& YukS1Quark2*YukS3Quark2*dBeta1KanUsual() - SA3*YukS1Quark1*dAlpha2KanUsual() + &
						& YukS1Quark3*dAlpha3KanUsual()

		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMDOSUsual()/MD - dMW2Usual()/(2D0*MW2) + dYukS1Quark2/YukS1Quark2 + &
			& dZDDOSLeft()/2D0 + dZDDOSRight()/2D0 + &
			& YukS1Quark1/YukS1Quark2*( dZH1H2OSUsual()/2D0 ) + YukS1Quark2/YukS1Quark2*( dZH2H2OS()/2D0 ) + &
			& YukS1Quark3/YukS1Quark2*( dZH3H2OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MD2)*MD2*YukS1Quark2**2)/(MW2*SW2)
	case (2)
		dRR11 = -CA2*SA1*dAlpha1KanUsual() - CA1*SA2*dAlpha2KanUsual()
		dRR12 = CA1*CA2*dAlpha1KanUsual() - SA1*SA2*dAlpha2KanUsual()
		dRR13 = CA2*dAlpha2KanUsual()
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1KanUsual() - &
						& YukS1Quark2*YukS3Quark2*dBeta2KanUsual() - SA3*YukS1Quark1*dAlpha2KanUsual() + &
						& YukS1Quark3*dAlpha3KanUsual()
	...
	case (3)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1KanAlter() - &
						& YukS1Quark2*YukS3Quark2*dBeta1KanAlter() - SA3*YukS1Quark1*dAlpha2KanAlter() + &
						& YukS1Quark3*dAlpha3KanAlter()

		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMDOSAlter()/MD - dMW2Alter()/(2D0*MW2) + dYukS1Quark2/YukS1Quark2 + &
			& dZDDOSLeft()/2D0 + dZDDOSRight()/2D0 + &
			& YukS1Quark1/YukS1Quark2*( dZH1H2OSAlter()/2D0 ) + YukS1Quark2/YukS1Quark2*( dZH2H2OS()/2D0 ) + &
			& YukS1Quark3/YukS1Quark2*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MD2)*MD2*YukS1Quark2**2)/(MW2*SW2)
	case (4)
		dRR11 = -CA2*SA1*dAlpha1KanAlter() - CA1*SA2*dAlpha2KanAlter()
		dRR12 = CA1*CA2*dAlpha1KanAlter() - SA1*SA2*dAlpha2KanAlter()
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1KanAlter() - &
						& YukS1Quark2*YukS3Quark2*dBeta2KanAlter() - SA3*YukS1Quark1*dAlpha2KanAlter() + &
						& YukS1Quark3*dAlpha3KanAlter()
	...
	case (5)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1PinchPStar() - &
						& YukS1Quark2*YukS3Quark2*dBeta1PinchPStar() - SA3*YukS1Quark1*dAlpha2PinchPStar() + &
						& YukS1Quark3*dAlpha3PinchPStar()
	...
	case (6)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1PinchPStar() - &
						& YukS1Quark2*YukS3Quark2*dBeta2PinchPStar() - SA3*YukS1Quark1*dAlpha2PinchPStar() + &
						& YukS1Quark3*dAlpha3PinchPStar()
	...
	case (7)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1PinchOS() - &
						& YukS1Quark2*YukS3Quark2*dBeta1PinchOS() - SA3*YukS1Quark1*dAlpha2PinchOS() + &
						& YukS1Quark3*dAlpha3PinchOS()
	...
	case (8)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1PinchOS() - &
						& YukS1Quark2*YukS3Quark2*dBeta2PinchOS() - SA3*YukS1Quark1*dAlpha2PinchOS() + &
						& YukS1Quark3*dAlpha3PinchOS()
	...
	case (9)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1MSBarUsual() - &
						& YukS1Quark2*YukS3Quark2*dBetaMSBarUsual() - SA3*YukS1Quark1*dAlpha2MSBarUsual() + &
						& YukS1Quark3*dAlpha3MSBarUsual()
	...
	case (10)
		...
		dYukS1Quark2 = ( SA2*YukS1Quark3 - CA2*CA3*YukS1Quark1 )*dAlpha1MSBarAlter() - &
						& YukS1Quark2*YukS3Quark2*dBetaMSBarAlter() - SA3*YukS1Quark1*dAlpha2MSBarAlter() + &
						& YukS1Quark3*dAlpha3MSBarAlter()
 ...
 H2toDDBarCT = totalAmplitude
end function H2toDDBarCT
