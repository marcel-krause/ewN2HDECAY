double precision function H3toElElBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 double precision :: dRR11, dRR12, dRR13, dRR21, dRR22, dRR23, dRR31, dRR32, dRR33, dYukS1Lep3
 ...
 select case (x)
	case (1)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1KanUsual() - &
						& YukS1Lep3*YukS3Lep2*dBeta1KanUsual() - CA3*YukS1Lep1*dAlpha2KanUsual() - &
						& YukS1Lep2*dAlpha3KanUsual()

		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSUsual()/ME - dMW2Usual()/(2D0*MW2) + dYukS1Lep3/YukS1Lep3 + &
			& dZElElOSLeft()/2D0 + dZElElOSRight()/2D0 + &
			& YukS1Lep1/YukS1Lep3*( dZH1H3OSUsual()/2D0 ) + YukS1Lep2/YukS1Lep3*( dZH2H3OSUsual()/2D0 ) + &
			& YukS1Lep3/YukS1Lep3*( dZH3H3OS()/2D0 ) &
			& )*(0.5D0*EL2*(MH32 - 4.D0*ME2)*ME2*YukS1Lep3**2)/(MW2*SW2)
	case (2)
		dRR11 = -CA2*SA1*dAlpha1KanUsual() - CA1*SA2*dAlpha2KanUsual()
		dRR12 = CA1*CA2*dAlpha1KanUsual() - SA1*SA2*dAlpha2KanUsual()
		dRR13 = CA2*dAlpha2KanUsual()
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1KanUsual() - &
						& YukS1Lep3*YukS3Lep2*dBeta2KanUsual() - CA3*YukS1Lep1*dAlpha2KanUsual() - &
						& YukS1Lep2*dAlpha3KanUsual()
	...
	case (3)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1KanAlter() - &
						& YukS1Lep3*YukS3Lep2*dBeta1KanAlter() - CA3*YukS1Lep1*dAlpha2KanAlter() - &
						& YukS1Lep2*dAlpha3KanAlter()
						
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMEOSAlter()/ME - dMW2Alter()/(2D0*MW2) + dYukS1Lep3/YukS1Lep3 + &
			& dZElElOSLeft()/2D0 + dZElElOSRight()/2D0 + &
			& YukS1Lep1/YukS1Lep3*( dZH1H3OSAlter()/2D0 ) + YukS1Lep2/YukS1Lep3*( dZH2H3OSAlter()/2D0 ) + &
			& YukS1Lep3/YukS1Lep3*( dZH3H3OS()/2D0 ) &
			& )*(0.5D0*EL2*(MH32 - 4.D0*ME2)*ME2*YukS1Lep3**2)/(MW2*SW2)
	case (4)
		dRR11 = -CA2*SA1*dAlpha1KanAlter() - CA1*SA2*dAlpha2KanAlter()
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1KanAlter() - &
						& YukS1Lep3*YukS3Lep2*dBeta2KanAlter() - CA3*YukS1Lep1*dAlpha2KanAlter() - &
						& YukS1Lep2*dAlpha3KanAlter()
	...
	case (5)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1PinchPStar() - &
						& YukS1Lep3*YukS3Lep2*dBeta1PinchPStar() - CA3*YukS1Lep1*dAlpha2PinchPStar() - &
						& YukS1Lep2*dAlpha3PinchPStar()
	...
	case (6)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1PinchPStar() - &
						& YukS1Lep3*YukS3Lep2*dBeta2PinchPStar() - CA3*YukS1Lep1*dAlpha2PinchPStar() - &
						& YukS1Lep2*dAlpha3PinchPStar()
	...
	case (7)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1PinchOS() - &
						& YukS1Lep3*YukS3Lep2*dBeta1PinchOS() - CA3*YukS1Lep1*dAlpha2PinchOS() - &
						& YukS1Lep2*dAlpha3PinchOS()
	...
	case (8)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1PinchOS() - &
						& YukS1Lep3*YukS3Lep2*dBeta2PinchOS() - CA3*YukS1Lep1*dAlpha2PinchOS() - &
						& YukS1Lep2*dAlpha3PinchOS()
	...
	case (9)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1MSBarUsual() - &
						& YukS1Lep3*YukS3Lep2*dBetaMSBarUsual() - CA3*YukS1Lep1*dAlpha2MSBarUsual() - &
						& YukS1Lep2*dAlpha3MSBarUsual()
	...
	case (10)
		...
		dYukS1Lep3 = ( -SA2*YukS1Lep2 + CA2*SA3*YukS1Lep1 )*dAlpha1MSBarAlter() - &
						& YukS1Lep3*YukS3Lep2*dBetaMSBarAlter() - CA3*YukS1Lep1*dAlpha2MSBarAlter() - &
						& YukS1Lep2*dAlpha3MSBarAlter()
 ...
 H3toElElBarCT = totalAmplitude
end function H3toElElBarCT
