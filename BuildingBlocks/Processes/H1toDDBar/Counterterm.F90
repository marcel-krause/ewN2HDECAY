double precision function H1toDDBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 double precision :: dRR11, dRR12, dRR13, dRR21, dRR22, dRR23, dRR31, dRR32, dRR33, dYukS1Quark1
 ...
 select case (x)
	case (1)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1KanUsual() - &
						& YukS1Quark1*YukS3Quark2*dBeta1KanUsual() - SA2/CA2*YukS1Quark1*dAlpha2KanUsual()

		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMDOSUsual()/MD - dMW2Usual()/(2D0*MW2) + dYukS1Quark1/YukS1Quark1 + &
			& dZDDOSLeft()/2D0 + dZDDOSRight()/2D0 + &
			& YukS1Quark1/YukS1Quark1*( dZH1H1OS()/2D0 ) + YukS1Quark2/YukS1Quark1*( dZH2H1OSUsual()/2D0 ) + &
			& YukS1Quark3/YukS1Quark1*( dZH3H1OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MD2)*MD2*YukS1Quark1**2)/(MW2*SW2)
	case (2)
		dRR11 = -CA2*SA1*dAlpha1KanUsual() - CA1*SA2*dAlpha2KanUsual()
		dRR12 = CA1*CA2*dAlpha1KanUsual() - SA1*SA2*dAlpha2KanUsual()
		dRR13 = CA2*dAlpha2KanUsual()
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1KanUsual() - &
						& YukS1Quark1*YukS3Quark2*dBeta2KanUsual() - SA2/CA2*YukS1Quark1*dAlpha2KanUsual()
	...
	case (3)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1KanAlter() - &
						& YukS1Quark1*YukS3Quark2*dBeta1KanAlter() - SA2/CA2*YukS1Quark1*dAlpha2KanAlter()

		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMDOSAlter()/MD - dMW2Alter()/(2D0*MW2) + dYukS1Quark1/YukS1Quark1 + &
			& dZDDOSLeft()/2D0 + dZDDOSRight()/2D0 + &
			& YukS1Quark1/YukS1Quark1*( dZH1H1OS()/2D0 ) + YukS1Quark2/YukS1Quark1*( dZH2H1OSAlter()/2D0 ) + &
			& YukS1Quark3/YukS1Quark1*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MD2)*MD2*YukS1Quark1**2)/(MW2*SW2)
	case (4)
		dRR11 = -CA2*SA1*dAlpha1KanAlter() - CA1*SA2*dAlpha2KanAlter()
		dRR12 = CA1*CA2*dAlpha1KanAlter() - SA1*SA2*dAlpha2KanAlter()
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1KanAlter() - &
						& YukS1Quark1*YukS3Quark2*dBeta2KanAlter() - SA2/CA2*YukS1Quark1*dAlpha2KanAlter()
	...
	case (5)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1PinchPStar() - &
						& YukS1Quark1*YukS3Quark2*dBeta1PinchPStar() - SA2/CA2*YukS1Quark1*dAlpha2PinchPStar()
	...
	case (6)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1PinchPStar() - &
						& YukS1Quark1*YukS3Quark2*dBeta2PinchPStar() - SA2/CA2*YukS1Quark1*dAlpha2PinchPStar()
	...
	case (7)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1PinchOS() - &
						& YukS1Quark1*YukS3Quark2*dBeta1PinchOS() - SA2/CA2*YukS1Quark1*dAlpha2PinchOS()
	...
	case (8)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1PinchOS() - &
						& YukS1Quark1*YukS3Quark2*dBeta2PinchOS() - SA2/CA2*YukS1Quark1*dAlpha2PinchOS()
	...
	case (9)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1MSBarUsual() - &
						& YukS1Quark1*YukS3Quark2*dBetaMSBarUsual() - SA2/CA2*YukS1Quark1*dAlpha2MSBarUsual()
	...
	case (10)
		...
		dYukS1Quark1 = ( CA2*CA3*YukS1Quark2 - CA2*SA3*YukS1Quark3 )*dAlpha1MSBarAlter() - &
						& YukS1Quark1*YukS3Quark2*dBetaMSBarAlter() - SA2/CA2*YukS1Quark1*dAlpha2MSBarAlter()
 ...
 H1toDDBarCT = totalAmplitude
end function H1toDDBarCT
