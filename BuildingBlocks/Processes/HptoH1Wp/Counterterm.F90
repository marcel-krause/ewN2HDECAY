double precision function HptoH1WpCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 select case (x)
	case (1)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta1KanUsual() - CB*RR11*dBeta1KanUsual() ) + &
	...
	case (2)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta2KanUsual() - CB*RR11*dBeta2KanUsual() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSUsual()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSUsual()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSUsual()/2D0 ) &
	...
	case (3)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta1KanAlter() - CB*RR11*dBeta1KanAlter() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
	...
	case (4)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta2KanAlter() - CB*RR11*dBeta2KanAlter() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSAlter()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSAlter()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (5)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta1PinchPStar() - CB*RR11*dBeta1PinchPStar() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSAlter()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSAlter()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (6)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta2PinchPStar() - CB*RR11*dBeta2PinchPStar() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSAlter()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSAlter()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (7)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta1PinchOS() - CB*RR11*dBeta1PinchOS() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSAlter()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSAlter()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (8)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBeta2PinchOS() - CB*RR11*dBeta2PinchOS() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSAlter()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSAlter()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (9)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBetaMSBarUsual() - CB*RR11*dBetaMSBarUsual() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSUsual()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSUsual()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSUsual()/2D0 ) &
	...
	case (10)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR12 - RR11*SB)*( CB*dRR12 - SB*dRR11 - SB*RR12*dBetaMSBarAlter() - CB*RR11*dBetaMSBarAlter() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR12 - RR11*SB)*( dZH1H1OS()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR12 - RR11*SB)*( dZH2H1OSAlter()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR12 - RR11*SB)*( dZH3H1OSAlter()/2D0 ) + &
			& (SB*RR12 + RR11*CB)/(CB*RR12 - RR11*SB)*( dZGpHpOSAlter()/2D0 ) &
 ...
 HptoH1WpCT = totalAmplitude
end function HptoH1WpCT
