double precision function H3toCCBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 select case (x)
	case (1)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - dBeta1KanUsual()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSUsual()/2D0 ) + RR22/RR32*( dZH2H3OSUsual()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (2)
		dRR11 = -CA2*SA1*dAlpha1KanUsual() - CA1*SA2*dAlpha2KanUsual()
		dRR12 = CA1*CA2*dAlpha1KanUsual() - SA1*SA2*dAlpha2KanUsual()
		dRR13 = CA2*dAlpha2KanUsual()
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - dBeta2KanUsual()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSUsual()/2D0 ) + RR22/RR32*( dZH2H3OSUsual()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (3)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta1KanAlter()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
	...
	case (4)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta2KanAlter()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSAlter()/2D0 ) + RR22/RR32*( dZH2H3OSAlter()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (5)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta1PinchPStar()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSAlter()/2D0 ) + RR22/RR32*( dZH2H3OSAlter()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (6)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta2PinchPStar()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSAlter()/2D0 ) + RR22/RR32*( dZH2H3OSAlter()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (7)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta1PinchOS()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSAlter()/2D0 ) + RR22/RR32*( dZH2H3OSAlter()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (8)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta2PinchOS()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSAlter()/2D0 ) + RR22/RR32*( dZH2H3OSAlter()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (9)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - dBetaMSBarUsual()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSUsual()/2D0 ) + RR22/RR32*( dZH2H3OSUsual()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case (10)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBetaMSBarAlter()/TB + dRR32/RR32 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR32*( dZH1H3OSAlter()/2D0 ) + RR22/RR32*( dZH2H3OSAlter()/2D0 ) + RR32/RR32*( dZH3H3OS()/2D0 ) &
			& )*(1.5D0*EL2*(MH32 - 4.D0*MC2)*MC2*RR32**2)/(MW2*SB2*SW2)
	case default
 ...
 H3toCCBarCT = totalAmplitude
end function H3toCCBarCT
