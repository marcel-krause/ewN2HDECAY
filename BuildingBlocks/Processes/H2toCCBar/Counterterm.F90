double precision function H2toCCBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 select case (x)
	case (1)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - dBeta1KanUsual()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSUsual()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (2)
		dRR11 = -CA2*SA1*dAlpha1KanUsual() - CA1*SA2*dAlpha2KanUsual()
		dRR12 = CA1*CA2*dAlpha1KanUsual() - SA1*SA2*dAlpha2KanUsual()
		dRR13 = CA2*dAlpha2KanUsual()
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - dBeta2KanUsual()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSUsual()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (3)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta1KanAlter()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (4)
		dRR11 = -CA2*SA1*dAlpha1KanAlter() - CA1*SA2*dAlpha2KanAlter()
		dRR12 = CA1*CA2*dAlpha1KanAlter() - SA1*SA2*dAlpha2KanAlter()
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta2KanAlter()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (5)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta1PinchPStar()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (6)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta2PinchPStar()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (7)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta1PinchOS()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (8)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBeta2PinchOS()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (9)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSUsual()/MC - dMW2Usual()/(2D0*MW2) - dBetaMSBarUsual()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSUsual()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case (10)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMCOSAlter()/MC - dMW2Alter()/(2D0*MW2) - dBetaMSBarAlter()/TB + dRR22/RR22 + &
			& dZCCOSLeft()/2D0 + dZCCOSRight()/2D0 + &
			& RR12/RR22*( dZH1H2OSAlter()/2D0 ) + RR22/RR22*( dZH2H2OS()/2D0 ) + RR32/RR22*( dZH3H2OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH22 - 4.D0*MC2)*MC2*RR22**2)/(MW2*SB2*SW2)
	case default
 ...
 H2toCCBarCT = totalAmplitude
end function H2toCCBarCT
