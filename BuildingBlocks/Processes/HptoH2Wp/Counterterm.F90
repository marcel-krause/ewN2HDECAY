double precision function HptoH2WpCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 select case (x)
	case (1)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta1KanUsual() - CB*RR21*dBeta1KanUsual() ) + &
	...
	case (2)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta2KanUsual() - CB*RR21*dBeta2KanUsual() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSUsual()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSUsual()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSUsual()/2D0 ) &
	...
	case (3)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta1KanAlter() - CB*RR21*dBeta1KanAlter() ) + &
	...
	case (4)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta2KanAlter() - CB*RR21*dBeta2KanAlter() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSAlter()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSAlter()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (5)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta1PinchPStar() - CB*RR21*dBeta1PinchPStar() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSAlter()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSAlter()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (6)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta2PinchPStar() - CB*RR21*dBeta2PinchPStar() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSAlter()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSAlter()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (7)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta1PinchOS() - CB*RR21*dBeta1PinchOS() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSAlter()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSAlter()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (8)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBeta2PinchOS() - CB*RR21*dBeta2PinchOS() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSAlter()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSAlter()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSAlter()/2D0 ) &
	...
	case (9)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBetaMSBarUsual() - CB*RR21*dBetaMSBarUsual() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSUsual()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSUsual()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSUsual()/2D0 ) &
	...
	case (10)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dZHpHpOS()/2D0 + dZWpWpOS()/2D0 + &
            & 1D0/(CB*RR22 - RR21*SB)*( CB*dRR22 - SB*dRR21 - SB*RR22*dBetaMSBarAlter() - CB*RR21*dBetaMSBarAlter() ) + &
			& (CB*RR12 - RR11*SB)/(CB*RR22 - RR21*SB)*( dZH1H2OSAlter()/2D0 ) + &
			& (CB*RR22 - RR21*SB)/(CB*RR22 - RR21*SB)*( dZH2H2OS()/2D0 ) + &
			& (CB*RR32 - RR31*SB)/(CB*RR22 - RR21*SB)*( dZH3H2OSAlter()/2D0 ) + &
			& (SB*RR22 + RR21*CB)/(CB*RR22 - RR21*SB)*( dZGpHpOSAlter()/2D0 ) &
 ...
 HptoH2WpCT = totalAmplitude
end function HptoH2WpCT
