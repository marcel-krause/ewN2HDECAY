double precision function H1toUUBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 select case (x)
	case (1)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSUsual()/MU - dMW2Usual()/(2D0*MW2) - dBeta1KanUsual()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSUsual()/2D0 ) + RR32/RR12*( dZH3H1OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (2)
		dRR11 = -CA2*SA1*dAlpha1KanUsual() - CA1*SA2*dAlpha2KanUsual()
		dRR12 = CA1*CA2*dAlpha1KanUsual() - SA1*SA2*dAlpha2KanUsual()
		dRR13 = CA2*dAlpha2KanUsual()
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSUsual()/MU - dMW2Usual()/(2D0*MW2) - dBeta2KanUsual()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSUsual()/2D0 ) + RR32/RR12*( dZH3H1OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (3)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBeta1KanAlter()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
	...
	case (4)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBeta2KanAlter()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSAlter()/2D0 ) + RR32/RR12*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (5)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBeta1PinchPStar()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSAlter()/2D0 ) + RR32/RR12*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (6)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBeta2PinchPStar()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSAlter()/2D0 ) + RR32/RR12*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (7)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBeta1PinchOS()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSAlter()/2D0 ) + RR32/RR12*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (8)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBeta2PinchOS()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSAlter()/2D0 ) + RR32/RR12*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (9)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSUsual()/MU - dMW2Usual()/(2D0*MW2) - dBetaMSBarUsual()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSUsual()/2D0 ) + RR32/RR12*( dZH3H1OSUsual()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case (10)
		...
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMUOSAlter()/MU - dMW2Alter()/(2D0*MW2) - dBetaMSBarAlter()/TB + dRR12/RR12 + &
			& dZUUOSLeft()/2D0 + dZUUOSRight()/2D0 + &
			& RR12/RR12*( dZH1H1OS()/2D0 ) + RR22/RR12*( dZH2H1OSAlter()/2D0 ) + RR32/RR12*( dZH3H1OSAlter()/2D0 ) &
			& )*(1.5D0*EL2*(MH12 - 4.D0*MU2)*MU2*RR12**2)/(MW2*SB2*SW2)
	case default
 ...
 H1toUUBarCT = totalAmplitude
end function H1toUUBarCT
