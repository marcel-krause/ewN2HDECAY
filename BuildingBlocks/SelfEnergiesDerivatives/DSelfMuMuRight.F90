...
#include "looptools.h"
 ...
 amplitudes(6) = (0.015625D0*EL2*MM2*(B0(x, 0.D0, MW2) + (-1.D0*MW2 + x)*DB0(x, 0.D0, MW2))*DBLE(YukS3Lep1**INT(2.D0)))/(MW2*PI2*&
  &SW2*x) - (0.015625D0*EL2*MM2*(A0(MW2) + (-1.D0*MW2 + x)*B0(x, 0.D0, MW2))*DBLE(x**INT(-2.D0))*DBLE(YukS3Lep1**INT(2.D0)))/(MW2&
  &*PI2*SW2)

 amplitudes(7) = (0.015625D0*EL2*MM2*(B0(x, 0.D0, MHp2) + (-1.D0*MHp2 + x)*DB0(x, 0.D0, MHp2))*DBLE(YukS3Lep2**INT(2.D0)))/(MW2*P&
  &I2*SW2*x) - (0.015625D0*EL2*MM2*(A0(MHp2) + (-1.D0*MHp2 + x)*B0(x, 0.D0, MHp2))*DBLE(x**INT(-2.D0))*DBLE(YukS3Lep2**INT(2.D0))&
  &)/(MW2*PI2*SW2)
 ...
 amplitudes(9) = (0.015625D0*EL2*(-4.D0*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, MM2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MM2*DB0(x, MM2, MZ2&
