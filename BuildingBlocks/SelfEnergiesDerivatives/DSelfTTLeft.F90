...
#include "looptools.h"
 ...
 amplitudes(6) = (-0.03125D0*CKM31*CKMC31*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MD**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM31*CKMC31*((0.5D0*EL2*MD2*SB2*B0(x, &
 ...
 amplitudes(7) = (-0.03125D0*CKM32*CKMC32*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MS2*SB2*A0(MS2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MS**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM32*CKMC32*((0.5D0*EL2*MS2*SB2*B0(x, &
 ...
 amplitudes(8) = (-0.03125D0*CKM33*CKMC33*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MB**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM33*CKMC33*((0.5D0*EL2*MB2*SB2*B0(x, &
 ...
 amplitudes(9) = (-0.03125D0*CKM31*CKMC31*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &*B0(x, MD2, MHp2)*DBLE(MD**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM31*CKMC31*((0.5D0*EL&
 ...
 amplitudes(10) = (-0.03125D0*CKM32*CKMC32*DBLE(x**INT(-2.D0))*((0.5D0*EL2*MS2*SB2*A0(MHp2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW&
  ...
  &*B0(x, MHp2, MS2)*DBLE(MS**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM32*CKMC32*((0.5D0*EL&
 ...
 amplitudes(11) = (-0.03125D0*CKM33*CKMC33*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW&
  ...
  &2*B0(x, MB2, MHp2)*DBLE(MB**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM33*CKMC33*((0.5D0*E&
 ...
 amplitudes(13) = (0.001736111111111111D0*EL2*(6.D0*CW2*SW2 - 6.D0*CW2*SW2*B0(x, MT2, MZ2) - 6.D0*CW2*MT2*SW2*DB0(x, MT2, MZ2) + &
  &6.D0*CW2*MZ2*SW2*DB0(x, MT2, MZ2) - 6.D0*CW2*SW2*x*DB0(x, MT2, MZ2) - 9.D0*DBLE(CW**INT(4.D0)) + 9.D0*B0(x, MT2, MZ2)*DBLE(CW*&
  &*INT(4.D0)) + 9.D0*MT2*DB0(x, MT2, MZ2)*DBLE(CW**INT(4.D0)) - 9.D0*MZ2*DB0(x, MT2, MZ2)*DBLE(CW**INT(4.D0)) + 9.D0*x*DB0(x, MT&
  &2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*DBLE(SW**INT(4.D0)) + B0(x, MT2, MZ2)*DBLE(SW**INT(4.D0)) + MT2*DB0(x, MT2, MZ2)*DBLE(SW**I&
  &NT(4.D0)) - 1.D0*MZ2*DB0(x, MT2, MZ2)*DBLE(SW**INT(4.D0)) + x*DB0(x, MT2, MZ2)*DBLE(SW**INT(4.D0))))/(CW2*PI2*SW2*x) - (0.0017&
  &36111111111111D0*EL2*(6.D0*CW2*SW2*x + 6.D0*CW2*SW2*A0(MT2) - 6.D0*CW2*SW2*A0(MZ2) - 6.D0*CW2*MT2*SW2*B0(x, MT2, MZ2) + 6.D0*C&
  &W2*MZ2*SW2*B0(x, MT2, MZ2) - 6.D0*CW2*SW2*x*B0(x, MT2, MZ2) - 9.D0*x*DBLE(CW**INT(4.D0)) - 9.D0*A0(MT2)*DBLE(CW**INT(4.D0)) + &
  &9.D0*A0(MZ2)*DBLE(CW**INT(4.D0)) + 9.D0*MT2*B0(x, MT2, MZ2)*DBLE(CW**INT(4.D0)) - 9.D0*MZ2*B0(x, MT2, MZ2)*DBLE(CW**INT(4.D0))&
  & + 9.D0*x*B0(x, MT2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*x*DBLE(SW**INT(4.D0)) - 1.D0*A0(MT2)*DBLE(SW**INT(4.D0)) + A0(MZ2)*DBLE(S&
  &W**INT(4.D0)) + MT2*B0(x, MT2, MZ2)*DBLE(SW**INT(4.D0)) - 1.D0*MZ2*B0(x, MT2, MZ2)*DBLE(SW**INT(4.D0)) + x*B0(x, MT2, MZ2)*DBL&
  &E(SW**INT(4.D0)))* DBLE(x**INT(-2.D0)))/(CW2*PI2*SW2)

 amplitudes(14) = (0.03125D0*CKM31*CKMC31*EL2*(-1.D0 + B0(x, MD2, MW2) + MD2*DB0(x, MD2, MW2) - 1.D0*MW2*DB0(x, MD2, MW2) + x*DB0&
 ...
 amplitudes(15) = (0.03125D0*CKM32*CKMC32*EL2*(-1.D0 + B0(x, MS2, MW2) + MS2*DB0(x, MS2, MW2) - 1.D0*MW2*DB0(x, MS2, MW2) + x*DB0&
 ...
 amplitudes(16) = (0.03125D0*CKM33*CKMC33*EL2*(-1.D0 + B0(x, MB2, MW2) + MB2*DB0(x, MB2, MW2) - 1.D0*MW2*DB0(x, MB2, MW2) + x*DB0&
