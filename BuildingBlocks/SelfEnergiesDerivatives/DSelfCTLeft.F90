...
#include "looptools.h"
 ...
 amplitudes(1) = (-0.03125D0*CKM31*CKMC21*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MD**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM31*CKMC21*((0.5D0*EL2*MD2*SB2*B0(x, &
 ...
 amplitudes(2) = (-0.03125D0*CKM32*CKMC22*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MS2*SB2*A0(MS2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MS**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM32*CKMC22*((0.5D0*EL2*MS2*SB2*B0(x, &
 ...
 amplitudes(3) = (-0.03125D0*CKM33*CKMC23*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MB**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM33*CKMC23*((0.5D0*EL2*MB2*SB2*B0(x, &
 ...
 amplitudes(4) = (-0.03125D0*CKM31*CKMC21*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &*B0(x, MD2, MHp2)*DBLE(MD**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM31*CKMC21*((0.5D0*EL&
 ...
 amplitudes(5) = (-0.03125D0*CKM32*CKMC22*DBLE(x**INT(-2.D0))*((0.5D0*EL2*MS2*SB2*A0(MHp2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &B0(x, MHp2, MS2)*DBLE(MS**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM32*CKMC22*((0.5D0*EL2&
 ...
 amplitudes(6) = (-0.03125D0*CKM33*CKMC23*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &*B0(x, MB2, MHp2)*DBLE(MB**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM33*CKMC23*((0.5D0*EL&
