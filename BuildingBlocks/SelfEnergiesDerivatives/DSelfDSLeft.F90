...
#include "looptools.h"
 ...
 amplitudes(1) = (0.03125D0*CKM11*CKMC12*((0.5D0*EL2*MU2*SB2*B0(x, MU2, MW2))/(MW2*SW2) - (0.5D0*EL2*MU2*SB2*DB0(x, MU2, MW2))/SW&
  &2 + (0.5D0*EL2*MU2*SB2*x*DB0(x, MU2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*DB0(x, MU2, MW2)*DBLE(MU**INT(4.D0)))/(MW2*SW2)))/(PI2*S&
  &B2*x) - (0.03125D0*CKM11*CKMC12*((-0.5D0*EL2*MU2*SB2*A0(MU2))/(MW2*SW2) + (0.5D0*EL2*MU2*SB2*A0(MW2))/(MW2*SW2) - (0.5D0*EL2*M&
 ...
 amplitudes(2) = (0.03125D0*CKM21*CKMC22*((0.5D0*EL2*MC2*SB2*B0(x, MC2, MW2))/(MW2*SW2) - (0.5D0*EL2*MC2*SB2*DB0(x, MC2, MW2))/SW&
  &2 + (0.5D0*EL2*MC2*SB2*x*DB0(x, MC2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*DB0(x, MC2, MW2)*DBLE(MC**INT(4.D0)))/(MW2*SW2)))/(PI2*S&
  &B2*x) - (0.03125D0*CKM21*CKMC22*((-0.5D0*EL2*MC2*SB2*A0(MC2))/(MW2*SW2) + (0.5D0*EL2*MC2*SB2*A0(MW2))/(MW2*SW2) - (0.5D0*EL2*M&
  &C2*SB2*B0(x, MC2, MW2))/SW2 + (0.5D0*EL2*MC2*SB2*x*B0(x, MC2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*B0(x, MC2, MW2)*DBLE(MC**INT(4.&
  &D0)))/(MW2*SW2))*DBLE(x**INT(-2.D0)))/(PI2*SB2)

 amplitudes(3) = (0.03125D0*CKM31*CKMC32*((0.5D0*EL2*MT2*SB2*B0(x, MT2, MW2))/(MW2*SW2) - (0.5D0*EL2*MT2*SB2*DB0(x, MT2, MW2))/SW&
  &2 + (0.5D0*EL2*MT2*SB2*x*DB0(x, MT2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*DB0(x, MT2, MW2)*DBLE(MT**INT(4.D0)))/(MW2*SW2)))/(PI2*S&
  &B2*x) - (0.03125D0*CKM31*CKMC32*((-0.5D0*EL2*MT2*SB2*A0(MT2))/(MW2*SW2) + (0.5D0*EL2*MT2*SB2*A0(MW2))/(MW2*SW2) - (0.5D0*EL2*M&
  &T2*SB2*B0(x, MT2, MW2))/SW2 + (0.5D0*EL2*MT2*SB2*x*B0(x, MT2, MW2))/(MW2*SW2) + (0.5D0*EL2*SB2*B0(x, MT2, MW2)*DBLE(MT**INT(4.&
  &D0)))/(MW2*SW2))*DBLE(x**INT(-2.D0)))/(PI2*SB2)

 amplitudes(4) = (0.03125D0*CKM11*CKMC12*((0.5D0*CB2*EL2*MU2*B0(x, MHp2, MU2))/(MW2*SW2) - (0.5D0*CB2*EL2*MHp2*MU2*DB0(x, MHp2, M&
  &U2))/(MW2*SW2) + (0.5D0*CB2*EL2*MU2*x*DB0(x, MHp2, MU2))/(MW2*SW2) + (0.5D0*CB2*EL2*DB0(x, MHp2, MU2)*DBLE(MU**INT(4.D0)))/(MW&
  &2*SW2)))/(PI2*SB2*x) - (0.03125D0*CKM11*CKMC12*((0.5D0*CB2*EL2*MU2*A0(MHp2))/(MW2*SW2) - (0.5D0*CB2*EL2*MU2*A0(MU2))/(MW2*SW2)&
 ...
 amplitudes(5) = (0.03125D0*CKM21*CKMC22*((0.5D0*CB2*EL2*MC2*B0(x, MC2, MHp2))/(MW2*SW2) - (0.5D0*CB2*EL2*MC2*MHp2*DB0(x, MC2, MH&
  &p2))/(MW2*SW2) + (0.5D0*CB2*EL2*MC2*x*DB0(x, MC2, MHp2))/(MW2*SW2) + (0.5D0*CB2*EL2*DB0(x, MC2, MHp2)*DBLE(MC**INT(4.D0)))/(MW&
  &2*SW2)))/(PI2*SB2*x) - (0.03125D0*CKM21*CKMC22*((-0.5D0*CB2*EL2*MC2*A0(MC2))/(MW2*SW2) + (0.5D0*CB2*EL2*MC2*A0(MHp2))/(MW2*SW2&
 ...
 amplitudes(6) = (0.03125D0*CKM31*CKMC32*((0.5D0*CB2*EL2*MT2*B0(x, MHp2, MT2))/(MW2*SW2) - (0.5D0*CB2*EL2*MHp2*MT2*DB0(x, MHp2, M&
  &T2))/(MW2*SW2) + (0.5D0*CB2*EL2*MT2*x*DB0(x, MHp2, MT2))/(MW2*SW2) + (0.5D0*CB2*EL2*DB0(x, MHp2, MT2)*DBLE(MT**INT(4.D0)))/(MW&
  &2*SW2)))/(PI2*SB2*x) - (0.03125D0*CKM31*CKMC32*((0.5D0*CB2*EL2*MT2*A0(MHp2))/(MW2*SW2) - (0.5D0*CB2*EL2*MT2*A0(MT2))/(MW2*SW2)&
