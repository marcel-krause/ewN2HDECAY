...
#include "looptools.h"
 ...
 amplitudes(1) = (-0.03125D0*EL2*ME2*DB1(x, ME2, MW2)*DBLE(YukS3Lep1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(2) = (-0.03125D0*EL2*ME2*DB1(x, ME2, MHp2)*DBLE(YukS3Lep2**INT(2.D0)))/(MW2*PI2*SW2)
