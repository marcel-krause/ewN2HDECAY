...
#include "looptools.h"
 ...
 amplitudes(9) = (0.015625D0*EL2*(2.D0*CW2*SW2 - 2.D0*CW2*SW2*B0(x, ML2, MZ2) - 2.D0*CW2*ML2*SW2*DB0(x, ML2, MZ2) + 2.D0*CW2*MZ2*&
  &SW2*DB0(x, ML2, MZ2) - 2.D0*CW2*SW2*x*DB0(x, ML2, MZ2) - 1.D0*DBLE(CW**INT(4.D0)) + B0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) + ML2*&
  &DB0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*MZ2*DB0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) + x*DB0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) &
  &- 1.D0*DBLE(SW**INT(4.D0)) + B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) + ML2*DB0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) - 1.D0*MZ2*DB0(x, &
  &ML2, MZ2)*DBLE(SW**INT(4.D0)) + x*DB0(x, ML2, MZ2)*DBLE(SW**INT(4.D0))))/(CW2*PI2*SW2*x) - (0.015625D0*EL2*(2.D0*CW2*SW2*x + 2&
  &.D0*CW2*SW2*A0(ML2) - 2.D0*CW2*SW2*A0(MZ2) - 2.D0*CW2*ML2*SW2*B0(x, ML2, MZ2) + 2.D0*CW2*MZ2*SW2*B0(x, ML2, MZ2) - 2.D0*CW2*SW&
  &2*x*B0(x, ML2, MZ2) - 1.D0*x*DBLE(CW**INT(4.D0)) - 1.D0*A0(ML2)*DBLE(CW**INT(4.D0)) + A0(MZ2)*DBLE(CW**INT(4.D0)) + ML2*B0(x, &
  &ML2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*MZ2*B0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) + x*B0(x, ML2, MZ2)*DBLE(CW**INT(4.D0)) - 1.D0*x*&
  &DBLE(SW**INT(4.D0)) - 1.D0*A0(ML2)*DBLE(SW**INT(4.D0)) + A0(MZ2)*DBLE(SW**INT(4.D0)) + ML2*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0))&
  & - 1.D0*MZ2*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)) + x*B0(x, ML2, MZ2)*DBLE(SW**INT(4.D0)))* DBLE(x**INT(-2.D0)))/(CW2*PI2*SW2)

 amplitudes(10) = 0.D0

 amplitudes(11) = 0.D0

 amplitudes(12) = (0.03125D0*EL2*(-1.D0 + B0(x, 0.D0, MW2) - 1.D0*MW2*DB0(x, 0.D0, MW2) + x*DB0(x, 0.D0, MW2)))/(PI2*SW2*x) - (0.&
