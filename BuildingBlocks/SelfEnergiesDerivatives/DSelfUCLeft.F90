...
#include "looptools.h"
 ...
 amplitudes(1) = (-0.03125D0*CKM21*CKMC11*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MD**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM21*CKMC11*((0.5D0*EL2*MD2*SB2*B0(x, &
 ...
 amplitudes(2) = (-0.03125D0*CKM22*CKMC12*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MS2*SB2*A0(MS2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MS**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM22*CKMC12*((0.5D0*EL2*MS2*SB2*B0(x, &
 ...
 amplitudes(3) = (-0.03125D0*CKM23*CKMC13*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2&
  ...
  &)*DBLE(MB**INT(4.D0))*DBLE(YukS3Quark1**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM23*CKMC13*((0.5D0*EL2*MB2*SB2*B0(x, &
 ...
 amplitudes(4) = (-0.03125D0*CKM21*CKMC11*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MD2*SB2*A0(MD2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &*B0(x, MD2, MHp2)*DBLE(MD**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM21*CKMC11*((0.5D0*EL&
 ...
 amplitudes(5) = (-0.03125D0*CKM22*CKMC12*DBLE(x**INT(-2.D0))*((0.5D0*EL2*MS2*SB2*A0(MHp2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &B0(x, MHp2, MS2)*DBLE(MS**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM22*CKMC12*((0.5D0*EL2&
 ...
 amplitudes(6) = (-0.03125D0*CKM23*CKMC13*DBLE(x**INT(-2.D0))*((-0.5D0*EL2*MB2*SB2*A0(MB2)*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2&
  ...
  &*B0(x, MB2, MHp2)*DBLE(MB**INT(4.D0))*DBLE(YukS3Quark2**INT(2.D0)))/(MW2*SW2)))/(PI2*SB2) + (0.03125D0*CKM23*CKMC13*((0.5D0*EL&
